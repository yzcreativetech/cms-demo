...
-- ---------------------------------------------------------
-- Remove current CMS content
-- Child rows are removed first because they reference
-- homepage_content through homepage_id.
-- ---------------------------------------------------------

delete from public.homepage_announcements
where homepage_id = 1;
...
-- ---------------------------------------------------------
-- Restore canonical homepage content
-- ---------------------------------------------------------
...
-- ---------------------------------------------------------
-- Restore canonical announcement/event content
-- ---------------------------------------------------------
